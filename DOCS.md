...
Gael:Working on this project helped me understand how different parts of a trading system connect, and why organizing data properly is so important. Building the Limit Order Book required thinking about priority rules, timestamps, and how to store orders efficiently, which gave me a clearer idea of how real exchange systems maintain fairness and speed. Even though our version is simplified, implementing the order flow, the priority queues, and the dashboard allowed me to practice modular programming and understand how each component plays a specific role. Overall, this project strengthened my ability to design structured solutions and work with concepts that reflect real-world software challenges